...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: shadcn chart theme injection is safe (internally generated CSS)
      ...
      <div className="grid gap-1.5">
        {payload
          ...
          .map((item, index) => {
            ...
            return (
              <div
                // biome-ignore lint/suspicious/noArrayIndexKey: shadcn legend items have no stable key
                key={index}
                className={cn(
